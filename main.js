(function($) {
  ...
  $("html").attr("ng-app", "toOnePageApp");
  $(".x-btn").attr("ng-click", "getContent($event)");
  $(".to-one-page").append("<dynamic-container page-data=''></dynamic-container>");
  //keep page from loading so Angular can handle it.
